...
<body>
   ...
   <div id="page-loader" class="fixed inset-0 z-50 flex flex-col items-center justify-center ">
    ...
    <div class="loader-logo-wrap relative w-28 h-28 flex items-center justify-center">
        ...
        <img
            src="{{ asset('assets/logo-black.png') }}"
            alt="Logo"
...
<style>
    ...
    @keyframes loaderPulse {
        0%,100% { transform: scale(1);    filter: drop-shadow(0 0 12px rgba(220,38,38,.6)); }
        50%      { transform: scale(1.08); filter: drop-shadow(0 0 28px rgba(220,38,38,1));  }
    }
    ...
    /* ── Fade out ── */
    #page-loader { transition: opacity .6s ease, visibility .6s ease; }
...
<script>
    ...
    (function () {
        ...
        pts.forEach(function(p) {
            ...
            el.style.cssText = 'left:50%;top:50%;--tx:'+p.tx+';--ty:'+p.ty+';--dur:'+p.dur+';--delay:'+p.delay;
            wrap.appendChild(el);
        });
    })();
