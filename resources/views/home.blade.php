...
<section id="section-hero" class="relative bg-cover bg-center text-white"
...
<section class="relative w-full overflow-hidden" style="min-height:920px;">
  ...
  <div class="slide active" id="slide-0">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 flex items-center min-h-[920px]">
      <div class="max-w-xl slide-content">
        <!-- Badge -->
        <span
          class="inline-flex items-center gap-2 text-xs font-semibold tracking-widest uppercase text-white/70 bg-white/10 border border-white/15 rounded-full px-4 py-1.5 mb-6">
  ...
  <!-- ── CONTROLS ── -->
  <!-- Prev / Next arrows -->
  <button onclick="HeroSlider.changeSlide(-1)"
    class="absolute left-5 top-1/2 -translate-y-1/2 z-20 w-11 h-11 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 flex items-center justify-center text-white transition-all ">
    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
      <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" />
    </svg>
  </button>
  <button onclick="HeroSlider.changeSlide(1)"
    class="absolute right-5 top-1/2 -translate-y-1/2 z-20 w-11 h-11 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 flex items-center justify-center text-white transition-all ">
    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
  ...
  <div class="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-center text-justify">
    ...
    <div>
      ...
      <p class="text-custom-text-content mt-5 text-base leading-relaxed">
        ...
        content that connects, editing visuals that sell, and building IT solutions that simply work, our services are
        designed to support your goals, not complicate them.
      </p>
      <p class="text-custom-text-content mt-5 text-base leading-relaxed">
        We are a trusted name among businesses looking for the best BPO agency in UK with our consistency and accuracy.
        We deliver efficient support each step of the way, even if you are looking to outsource routine processes or
        build a lasting brand online. Being a complete service provider, we are proud to be the best BPO outsourcing
        company in UK.
      </p>
      <p class="text-custom-text-content mt-5 text-base leading-relaxed"></p>
      We believe in custom solutions, clear communication, and delivering results you can measure. If you are looking
      for a long-term partner instead of a quick fix, we are the right fit for you.
      </p>
    </div>
    <!-- Image Content -->
    <div class="relative">
  ...
  <div class="max-w-7xl mx-auto px-4">
    ...
    <div class="flex flex-col md:flex-row md:justify-between md:items-end mb-12 gap-6">
      ...
      <div class="flex items-center gap-4">
        ...
        <!-- Prev -->
        <button id="prevBtn" onclick="ServiceSlider.slide(-1)"
          class="nav-btn w-11 h-11 rounded-full border-2 border-gray-300 flex items-center justify-center" disabled>
          <svg class="w-5 h-5 text-custom-blue-navy" fill="none" stroke="currentColor" stroke-width="2.5"
            viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" />
          </svg>
        </button>
    ...
    <div class="overflow-hidden" id="viewport">
      <div class="cards-track" id="track">
        ...
        <div class="service-card bg-custom-blue-dark text-white p-7 rounded-2xl shadow-xl">
          ...
          <p class="mt-4 text-sm leading-relaxed text-white/65 text-justify">A professionally edited image can
            communicate
...
<section id="section-connect" class="py-16">
  <div class="max-w-7xl mx-auto px-4">
    <div class="relative bg-cover bg-center rounded-3xl py-24 text-center text-white"
      style="background-image: url('{{ asset('assets/71be37ed7d6abbe916aaf19e951baa48756f0be3.png') }}');">
      ...
      <div class="relative z-10 flex flex-col items-center p-4">
        ...
        <p class="mt-5 max-w-3xl text-lg text-gray-200">Looking for the best BPO agency in UK to handle your processes?
          Our solutions can simplify your operations.</p>
        <a href="/contact-us"
          class="mt-12 inline-block bg-custom-red-brand text-white px-8 py-3 rounded-2xl font-bold hover:bg-red-700">Contact
          Us</a>
      </div>
    </div>
  </div>
...
<section id="section-industries" class="bg-white py-16">
  <div class="max-w-5xl mx-auto">
    ...
    <div class="flex flex-wrap justify-center gap-3">
      ...
      <span
        class="industry-pill group flex items-center gap-2.5 px-5 py-3 rounded-full border-2 border-gray-200 bg-white text-brand-orange font-semibold text-sm transition-all duration-200 hover:bg-brand-red hover:border-brand-red hover:text-white hover:shadow-md">
        <svg class="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"
      ...
      <span
        ...
        <svg class="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"
          stroke-linecap="round" stroke-linejoin="round">
          <path
            d="M17.8 19.2L16 11l3.5-3.5C21 6 21 4 19 2s-4 0-5.5 1.5L10 7 2 5.2l-1 1 6 4-2 2-4-1-1 1 3 2 2 3 1-1-1-4 2-2 4 6z" />
        </svg>
        Travel
      </span>
      ...
      <span
        ...
        <svg class="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"
          stroke-linecap="round" stroke-linejoin="round">
          <path d="M2 20V10l6-5v5l6-5v5l6-5v10z" />
        ...
        <div class="space-y-4">
          ...
          <div class="accordion-item bg-custom-blue-dark text-white rounded-lg p-6">
            <div class="accordion-header flex justify-between items-center cursor-pointer">
              ...
              <svg class="accordion-icon w-6 h-6 transition-all duration-300" viewBox="0 0 24 24" fill="none"
    ...
    <div class="grid grid-cols-12 gap-8 items-start">
      ...
      <div class="col-span-12 md:col-span-8">
        <div id="testiViewport" class="overflow-hidden cursor-grab active:cursor-grabbing select-none">
          <div id="testiTrack" class="flex gap-6 transition-transform duration-500 ease-in-out will-change-transform">
          </div>
        </div>
      </div>
    ...
    <form class="mt-12 space-y-5">
      <div class="grid sm:grid-cols-2 gap-5">
        <input type="text" placeholder="Your Name"
          class="w-full p-4 rounded-lg border border-gray-300 bg-white text-gray-700 placeholder:text-custom-text-secondary">
      ...
      <textarea placeholder="Type Your Message"
        class="w-full p-4 rounded-lg border border-gray-300 bg-white text-gray-700 placeholder:text-custom-text-secondary h-36"></textarea>
      <button type="submit"
        class="w-full bg-custom-red-dark text-white p-4 rounded-lg font-bold text-lg hover:bg-red-700">Submit
        Message</button>
    </form>
  </div>
</section>
...
<section id="section-strategies" class="bg-gray-50 py-16 font-body">
  <div class="max-w-7xl mx-auto px-4 text-center">
    ...
    <div id="stratViewport" class="mt-16 overflow-hidden cursor-grab active:cursor-grabbing select-none pb-5">
      <div id="stratTrack"
        class="flex gap-8 text-left transition-transform duration-500 ease-in-out will-change-transform"></div>
    </div>
    ...
    <div class="md:flex gap-6 mt-16">
      ...
      <div class="flex flex-col gap-6 w-full">
        <div class="faqx-item bg-gray-100 border rounded-lg overflow-hidden">
          ...
          <div class="faqx-answer max-h-0 overflow-hidden transition-all duration-300 px-6">
            <p class="py-4 text-gray-600">
              Yes, being the best BPO outsourcing company in UK, we offer scalable services that grow with your
              business. We scale our team and services while maintaining the quality.
            </p>
          </div>
        </div>
        ...
        <div class="faqx-item bg-gray-100 border rounded-lg overflow-hidden">
          ...
          <div class="faqx-answer max-h-0 overflow-hidden transition-all duration-300 px-6">
            <p class="py-4 text-gray-600">
              At Allianze Digital, being the best BPO agency in UK, we make use of secure servers and follow stringent
              security protocols and industry regulations.
            </p>
          </div>
        </div>
        ...
        <div class="faqx-item bg-gray-100 border rounded-lg overflow-hidden">
          <button class="faqx-question w-full p-6 flex justify-between items-center text-left">
            <p class="font-semibold">03. Is it possible to outsource just a part of our operations to Allianze Digital?
            </p>
            <span class="faqx-icon text-xl font-bold">+</span>
          </button>
          <div class="faqx-answer max-h-0 overflow-hidden transition-all duration-300 px-6">
            <p class="py-4 text-gray-600">
              Of course, we can take care of specific tasks, even if it is just document processing or full-cycle
              back-office support.
            </p>
          </div>
        </div>
        ...
        <div class="faqx-item bg-gray-100 border rounded-lg overflow-hidden">
          ...
          <div class="faqx-answer max-h-0 overflow-hidden transition-all duration-300 px-6">
            <p class="py-4 text-gray-600">
              Yes, as the best BPO outsourcing company in UK, we have an expert team that efficiently handles a high
              volume of data processing tasks with accuracy and quick delivery.
            </p>
          </div>
        </div>
        ...
        <div class="faqx-item bg-gray-100 border rounded-lg overflow-hidden">
          ...
          <div class="faqx-answer max-h-0 overflow-hidden transition-all duration-300 px-6">
            <p class="py-4 text-gray-600">
              Our wide range of digital marketing services includes Search Engine Optimization (SEO), content marketing,
              and Social Media Management (SMM) that align with your goals.
            </p>
          </div>
        </div>
        ...
        <div class="faqx-item bg-gray-100 border rounded-lg overflow-hidden">
          ...
          <div class="faqx-answer max-h-0 overflow-hidden transition-all duration-300 px-6">
            <p class="py-4 text-gray-600">
              Our team will keep you updated on the progress through detailed monthly reports with metrics including
              leads, traffic, conversion rates, and ad performance.
            </p>
          </div>
        </div>
        ...
        <div class="faqx-item bg-gray-100 border rounded-lg overflow-hidden">
          ...
          <div class="faqx-answer max-h-0 overflow-hidden transition-all duration-300 px-6">
            <p class="py-4 text-gray-600">
              We have assisted clients from multiple verticals, including real estate, healthcare, ecommerce, education,
              and B2B sectors.
            </p>
          </div>
        </div>
      ...
      <div class="flex flex-col gap-6 w-full">
        ...
        <div class="faqx-item bg-gray-100 border rounded-lg overflow-hidden">
          ...
          <div class="faqx-answer max-h-0 overflow-hidden transition-all duration-300 px-6">
            <p class="py-4 text-gray-600">
              Absolutely, we have assisted numerous ecommerce brands in enhancing their product images for better sales
              and presentation.
            </p>
          </div>
        </div>
...
<section id="section-cta-final" class="py-16">
  <div class="max-w-7xl mx-auto px-4">
    <div class="bg-custom-blue-light rounded-2xl md:rounded-full p-4 md:p-8 bg-blend-lighten bg-cover bg-center"
      style="background-image: url('{{ asset('assets/9efd5264bd0bfb5085bf24e8b6997c95fe61a020.png') }}'); background-color: rgba(217, 228, 255, 0.8);">
      <div class="flex flex-col md:flex-row justify-between items-center gap-6">
        <h2 class="text-2xl md:text-3xl font-bold text-custom-blue-dark max-w-4xl text-center md:text-left">Take the
          First step towards more innovative solutions with the best BPO agency in UK.</h2>
        <a href="/contact-us"
          class="flex-shrink-0 w-40 h-40 bg-custom-red-dark rounded-full flex items-center justify-center text-white font-bold text-center text-lg leading-tight shadow-2xl hover:bg-red-700 transition-transform transform hover:scale-105">Contact
          us now</a>
      </div>
    </div>
  </div>
